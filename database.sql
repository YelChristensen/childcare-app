...
INSERT INTO nanny 
  (id, first_name, last_name, photo, city, tel, email, child_age, filter, bio) 
  VALUES 
...
INSERT INTO nanny 
  (id, first_name, last_name, photo, city, tel, email, child_age,filter, bio) 
  VALUES 
  (3, 'Sarah', 'Sanderson', 'https://childcareapp.s3.eu-west-2.amazonaws.com/image_3.jpg', 'London',08947539084, 'sarah.sanderson@gmail.com', '0-4','night nanny', 'I have recently just had my first baby ,a little boy so I am currently on maternity leave until september 2020. ');
INSERT INTO nanny 
  (id, first_name, last_name, photo, city, tel, email, child_age, filter, bio) 
  VALUES 
